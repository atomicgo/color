...
<a name="Black"></a>Color shortcut functions apply common ANSI styles to text.
...
<a name="ANSIColor"></a>
## type [ANSIColor](<https://github.com/atomicgo/color/blob/main/color-ansi.go#L26>)
...
<a name="ANSIBlack"></a>ANSI color constants define the standard foreground color palette.
...
### func \(ANSIColor\) [Sequence](<https://github.com/atomicgo/color/blob/main/color-ansi.go#L29>)
...
<a name="NoColor"></a>NoColor disables color output for a style component.
...
<a name="TrueColor"></a>Color modes describe the terminal color capabilities.
...
### func \(Mode\) [String](<https://github.com/atomicgo/color/blob/main/mode.go#L15>)
